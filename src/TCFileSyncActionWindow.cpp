...
namespace tc
{
    namespace file_sync
    {
        ...
        private:
            ...
            void drawContent(const FX::FXTable* table, FX::FXDC& dc, FX::FXint
                x, FX::FXint y, FX::FXint w, FX::FXint h) const override;
        ...
        public:
            CheckTableItem(FX::FXTable *table, FX::FXIcon *ic = nullptr, void *ptr = nullptr);
            virtual ~CheckTableItem(void) { delete check; }

            void setCheck(FX::FXbool s = TRUE, FX::FXbool notify = FALSE) 
            {
                check->setCheck(s, notify);
            }
        ...
        TCGUIBASE_IMPLEMENT(ActionWindow, FX::FXTopWindow, ActionWindowMap, ARRAYNUMBER(ActionWindowMap))
            ...
            :FX::FXTopWindow(window, "Action Window",
                nullptr, nullptr, FX::DECOR_ALL, 500, 50, 400, 0, 0, 0, 0, 0, 0, 0)
        {
            // Table
